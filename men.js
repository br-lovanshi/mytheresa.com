...
h1.innerText = "Vacation Shop 2022";
let btn = document.createElement("button");
btn.innerText = "Shop Now >>";
// btn.addEventListener("click",allProductfun){
//     window.location.href=""
// }
hero.append(h4,h1,btn);
...
import {arrivals} from "./components/compoents.js";
product1.innerHTML = arrivals();

// let proMen = ;
import {product1Men} from "./components/compoents.js";
document.getElementById("here").innerHTML = product1Men();
...
data.forEach(el => {
    ...
    divMain.setAttribute("class","pro");
    let div = document.createElement("div");
    div.setAttribute("class","discription");

    let h5 = document.createElement("h5");
    h5.innerText =el.name;
    let netPrice = document.createElement("div");
    netPrice.innerText = "₹"+el.price;
    let h4 = document.createElement("h4");
    h4.innerText ="₹"+el.strikedoffprice;
 ...
 localStorage.setItem("userData",JSON.stringify(productCart));
   alert("item added on cart");
    ...
    div.append(img,h5,netPrice,h4,cart);
    divMain.append(div);

    document.querySelector(".pro-container").append(divMain);
});
  ...
  let banner = document.getElementById("sm-banner");

  import {  banners} from "./components/compoents.js";
  banner.innerHTML=banners();
  
  let texts = document.getElementById("text");

  import {  textCon} from "./components/compoents.js";
  texts.innerHTML=textCon();
 let pageChange1 = document.getElementById("pageChange1");
 pageChange1.addEventListener("click",function(){
...
let proPaeg = document.getElementById("proPage").addEventListener("click",proPageFun)
  function proPageFun(){
    window.location.href="product.html"
  }